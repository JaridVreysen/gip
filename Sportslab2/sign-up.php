                    ...
                    <div class="col-12 col-lg-6 m-auto">
                        <div class="row my-5">
                            <div class="col-sm-10 col-xl-8 m-auto">
                                ...
                                <p id="createInformation" class="text-danger"></p>
                                <!-- Form START -->
                                <?php
                                 echo '<form id="createForm" action="includes/signup.php" method="post">
                                    <!-- Email -->
                                    <div class="mb-4">
                                    ...
                                    <div class="col-6 mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="password"
                                                class="form-control border-0 bg-light rounded-end ps-1"
                                                placeholder="*********" id="Password1" name="Password1">
                                        </div>
                                    </div>
                                    <!-- Confirm Password -->
                                    <div class="col-6 mb-4">
                                    ...
                                    <div class="align-items-center mt-0">
                                        <div class="d-grid">
                                            <button class="btn btn-primary mb-0" type="button" onclick="signup()" name="button">Sign up</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- Form END -->'
