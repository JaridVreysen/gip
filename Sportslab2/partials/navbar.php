            ...
            <div class="container">
                                    ...
                                    <div class="row p-4">
                                        ...
                                        <div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
                                            ...
                                            <div class="d-flex mb-4 position-relative">
                                                ...
                                                <div class="ms-3">
                                                    <h6 class="mb-0"><a class="stretched-link" href="#">American Century
                                            ...
                                            <div class="d-flex mb-4 position-relative">
                                                ...
                                                <div class="ms-3">
                                                    <h6 class="mb-0"><a class="stretched-link" href="#">Indiana College
                                                            of - Bloomington</a></h6>
                                            ...
                                            <div class="d-flex mb-4 position-relative">
                                                ...
                                                <div class="ms-3">
                                                    <h6 class="mb-0"><a class="stretched-link" href="#">College of South
                                                            Florida</a></h6>
                                            ...
                                            <div class="d-flex position-relative">
                                                ...
                                                <div class="ms-3">
                                                    <h6 class="mb-0"><a class="stretched-link" href="#">University of
                                        ...
                                        <div class="col-xl-6 col-xxl-4">
                                            ...
                                            <div class="d-flex mb-4 position-relative">
                                                ...
                                                <div class="ms-2">
                                                    <h6 class="mb-0"><a class="stretched-link" href="#">Facebook social
                ...
                <div class="navbar-collapse collapse" id="navbarCollapse">
                    <ul class="navbar-nav navbar-nav-scroll ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="course-grid-2.php">Courses</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="course-list-2.php">Fiches</a>
                        </li>
                    </ul>
                </div>
                <!-- Main navbar END -->
