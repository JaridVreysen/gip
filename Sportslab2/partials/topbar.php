				...
				<div class="container-fluid p-0">
					<div class="d-flex align-items-center w-100">
                        ...
                        if(isset($_SESSION['id'])){
                            ...
                            $sql = "SELECT `id`, `firstname`,`lastname`, `profilePicture`,`email`, FROM `user` WHERE id = ?;";
                            ...
                            if($row = $result->fetch_assoc()){
								...
								<li class="nav-item ms-2 ms-md-3 dropdown">
									...
									<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
										<img class="avatar-img rounded-circle" src="'.$profilePicture.'" alt="avatar">
									</a>
										...
										<li class="px-3">
											<div class="d-flex align-items-center">
												...
												<div class="avatar me-3 mb-3">
													<img class="avatar-img rounded-circle shadow" src="'.$profilePicture.'" alt="avatar">
												</div>
												<div>
													<a class="h6 mt-2 mt-sm-0" href="#">'.$firstname.' '.$lastname.'</a>
                                ...
                                echo "<h1>Welcome to Promotion<h1>";
                            }
                        } else {
                            echo "<h1>Welcome to Promotion<h1>";
                        };
