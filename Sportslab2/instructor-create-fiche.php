			...
			<div class="container">
				<div class="row">
					<div class="col-12 text-center">
						<!-- Title -->
						<h1 class="text-white">Submit a new Fiche</h1>
										...
										<div class="row g-4 mb-4">
											...
											<div class="col-6">
												...
												<input class="form-control" type="text" placeholder="Enter Fiche Title"
												  placeholder="fiche title" id="ficheTitle" name="ficheTitle">
											</div>
										...
										<div class="row g-4 mb-4 mt-7">
											...
											<div class="col-6">
												...
												<input class="form-control" type="text" placeholder="Enter Muscle Type"
												  placeholder="muscles" id="muscles" name="muscles">
											</div>
											...
											<div class="col-6">
												...
												<input class="form-control" type="text" placeholder="Enter Exercise Name"
												  placeholder="exercise" id="exercise" name="exercise">
											</div>
										</div>
